...
namespace aanimation\arhamplugin\fields;

use aanimation\arhamplugin\ArhamPlugin;
use aanimation\arhamplugin\assetbundles\arhamfield\ArhamFieldAsset;
...
class Arham extends Field
{
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'arham-plugin/_components/fields/Arham_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(ArhamFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').ArhamPluginArham(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'arham-plugin/_components/fields/Arham_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
