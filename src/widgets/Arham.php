...
namespace aanimation\arhamplugin\widgets;

use aanimation\arhamplugin\ArhamPlugin;
use aanimation\arhamplugin\assetbundles\arhamwidget\ArhamWidgetAsset;
...
class Arham extends Widget
{
    ...
    {
        return Craft::getAlias("@aanimation/arhamplugin/assetbundles/arhamwidget/dist/img/Arham-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'arham-plugin/_components/widgets/Arham_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(ArhamWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'arham-plugin/_components/widgets/Arham_body',
            [
